      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Text(
              'AI-Based Anonymous Peer Support',
              style: Theme.of(context)
                  .textTheme
                  .bodyMedium
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildFeatureItem(
                      ...
                      Icons.emergency,
                      'Crisis Support',
                      'Immediate access to helplines',
                    ),
                    _buildFeatureItem(
                      context,
                      Icons.cloud,
                      'Backend Ready',
                      'Local-first now, cloud-ready later',
                    ),
                  ],
                ),
              ),
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        ...
                        _buildTechChip(context, 'AWS Bedrock'),
                        _buildTechChip(context, 'AI/ML'),
                        _buildTechChip(context, 'WebSocket'),
                        _buildTechChip(context, 'SQLite'),
                        _buildTechChip(context, 'DynamoDB'),
                      ],
                    ),
                  ],
                ),
            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    const Text('Hackathon', style: TextStyle(fontSize: 24)),
                    const SizedBox(height: 8),
                    Text(
