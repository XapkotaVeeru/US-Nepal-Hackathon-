    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          _item('Lambda', state.lambdaFunction.isEmpty ? '-' : state.lambdaFunction),
          _item(
            'Execution',
          ...
          _item('Bedrock', state.bedrockResult),
          _item('Dynamo Read', state.dynamoRead),
          _item('Dynamo Write', state.dynamoWrite),
